...
--
-- Host: localhost    Database: wordle_GUILD
-- ------------------------------------------------------
...
CREATE TABLE `earned_achievements` (
  ...
  CONSTRAINT `earned_achievements_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `earned_achievements_ibfk_2` FOREIGN KEY (`achievement_id`) REFERENCES `wordle`.`achievements` (`id`)
...
CREATE TABLE `games` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_user_game` (`user_id`,`game_number`),
  CONSTRAINT `games_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `CONSTRAINT_1` CHECK (`game_number` < 10000),
  CONSTRAINT `CONSTRAINT_2` CHECK (`score` in ('1','2','3','4','5','6','x'))
...
-- Dump completed on 2023-11-05 14:26:43